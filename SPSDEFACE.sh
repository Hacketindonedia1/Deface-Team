...
toilet -f standard " SPS DEFACE "
echo
echo ""
echo "================================"
echo $red"CREATED=HACKER.OMLINE"
echo $green"VERSION=0.1"
echo $green"Youtube=Hacker online"
echo $green"Team=anonymous Cyber army"
echo $blue "whatspapp=089655478810"
echo "================================="
echo
